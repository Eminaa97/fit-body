...
namespace FitBody.DataBase.Migrations
{
    ...
    partial class FitBodyContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitBody.Models.PostComment", b =>
                {
            ...
            modelBuilder.Entity("FitBody.Models.Thread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("FitBody.Models.ThreadComment", b =>
                {
                    ...
                    b.HasKey("ThreadId", "CommentId");

                    b.HasIndex("CommentId");

                    b.ToTable("thread_comments");
                });
            ...
            modelBuilder.Entity("FitBody.Models.PostComment", b =>
                {
                    b.HasOne("FitBody.Models.Comment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("FitBody.Models.ThreadComment", b =>
                {
                    ...
                    b.HasOne("FitBody.Models.Thread", "Thread")
                        .WithMany()
