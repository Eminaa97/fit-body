...
namespace FitBody.Api
{
    public static class DatabaseInitializer
    {
        public static void Initialize(FitBodyContext context)
        {
            ...
            #region Users
            var eminaSalt = UserService.GenerateSalt();
            var emina = new User
            {
                ...
                Height = 1.69f,
                Weight = 62.0f,
                Info = "I am a super user and you're not",
                Mobile = "+38673265312",
                UserName = "admin",
                PasswordSalt = eminaSalt,
                PasswordHash = UserService.GenerateHash(eminaSalt, "admin"),
                Active = true,
                Gender = "Female",
            };
            context.Users.Add(emina);


            var armanSalt = UserService.GenerateSalt();
            var arman = new User
            {
                BirthDate = new DateTime(1997, 4, 17),
                Email = "arman@com.test",
                FirstName = "Arman",
                LastName = "Ossi Loko",
            ...
            context.Users.Add(arman);


            var dzenoSalt = UserService.GenerateSalt();
            var dzeno = new User
            {
                BirthDate = new DateTime(1997, 8, 1),
                Email = "dzenan@test.com",
                FirstName = "Dzenan",
                LastName = "Sakic",
...
- pomaže psihološkom zdravlju"
            ...
            var comment = new Comment
            {
                ...
                Content = "Hello dzeno, hope you find the info you need here"
            };
